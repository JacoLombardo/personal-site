...
const HIGHLIGHTED_IDS = ["squisito", "42_webserv", "42_ft_transcendence", "vid-base"];
...
function LinkedInIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={styles.sd_contact_svg} aria-hidden>
      ...
      return (
        <div className={`${styles.sd_slide} ${styles.sd_contact_slide}`}>
          ...
          <div className={styles.sd_contact_icons}>
            <a href="https://github.com/JacoLombardo" target="_blank" rel="noopener noreferrer" className={styles.sd_contact_link} aria-label="GitHub">
              <GitHubIcon />
            </a>
            <a href="https://www.linkedin.com/in/jacopo-lombardo/" target="_blank" rel="noopener noreferrer" className={styles.sd_contact_link} aria-label="LinkedIn">
              <LinkedInIcon />
            </a>
            <a href="mailto:jacopo.lombardo@outlook.com" className={styles.sd_contact_link} aria-label="Email">
              <EmailIcon />
            </a>
          </div>
    ...
    <>
      ...
      <div className={styles.sd_page}>
        ...
        <div className={styles.sd_content_wrap}>
          ...
          {showRightArrow && (
            <button type="button" className={`${styles.sd_arrow} ${styles.sd_arrow_right}`} onClick={goNext} aria-label="Next">
              ›
            </button>
          )}
          {renderSlide()}
